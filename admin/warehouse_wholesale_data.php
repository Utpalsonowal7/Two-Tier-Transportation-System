...
// // Count total records
// $total_query = "SELECT COUNT(*) AS total FROM transport";
...
<body>
     ...
     <div class="main-content">
          <div class="dashboard">
               ...
               <h3 class="slash">/</h3>
               <a href="#">
                    <h2>Warehouse to Wholesalers Transport Data</h2>
               </a>
          </div>
                    ...
                    <tbody>
                         ...
                         while ($row = pg_fetch_assoc($result)) {
                              ...
                              <tr>
                                   ...
                                   <td><?php echo date('Y-m-d', strtotime($row['transport_date'])); ?></td>
                                   ...
                                   <td>
                                        <div class="button-group">
                                             ...
                                             <button class="delete-btn"><a
                                                       href="delete_warehouse_wholesaler_trans+_data.php?id=<?php echo $row['id']; ?>"
      ...
      <script>
               $(document).ready(function () {
                    if ($.fn.dataTable.isDataTable('#tier1Data')) {
                         $('#tier1Data').DataTable().destroy();
                    }

                    let table = $('#tier1Data').DataTable({
                         paging: true,
                         lengthChange: true,
                         searching: true,
                         ordering: true,
