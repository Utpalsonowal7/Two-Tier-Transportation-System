...
// $total_query = "SELECT COUNT(*) AS total FROM retailers";
     ...
     <div class="main-content">
          ...
          <div class="table-container">
               ...
               <table id="RetailerTable">
                    ...
                    <?php
                    $query = "SELECT * FROM retailers order by serial_no ASC ";
                                   ...
                                   <td>
                                        <div class="button-group">
                                             <button class="update-btn"><a
                                                       href="edit_retailer.php?id=<?php echo urldecode(encrypt_id( $row['serial_no'])); ?>">Update</a></button>
