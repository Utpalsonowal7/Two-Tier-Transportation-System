     ...
     <div class="main-content">
          ...
          <div class="table-container">
               ...
               <table id="dataTable">
                    ...
                    <?php
                    $query = "SELECT * FROM district_admins ORDER BY username ASC";
                                   ...
                                   <td>
                                        <div class="button-group">
                                             <button class="update-btn"><a
                                                       href="edit_district_admin.php?id=<?php echo urlencode(encrypt_id($row['id'])); ?>">Update</a></button>
                                             <button class="delete-btn"><a
                                                       href="delete_district_admin.php?id=<?php echo $row['id']; ?>"
                                                       onclick="return confirm('Are you sure you want to delete this admin?');">Delete</a></button>
                                             <button class="view-btn"><a
                                                       href="reset_distAdmin_pass.php?id=<?php echo urldecode(encrypt_id($row['id'])); ?>">Reset
                                                       Pass..</a></button>
                                        </div>
                                   </td>
                              </tr>
