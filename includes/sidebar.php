          ...
          <nav class="sidebar-nav">
               <ul>
                    ...
                    <li class="dropdown"><a><i class="fa-solid fa-link"></i></i>Mapping Data<span><i class="fa-solid fa-plus"
                                        onclick="toggleDropdown(event)"></i></span></a>
                         <ul class=" dropdown-menu">
                              <li><a href="wholesale_map.php"><i class="fas fa-warehouse"></i> Warehouse_wholesale Map</a>
                              </li>
                    ...
                    <li class="dropdown"><a><i class="fa-solid fa-truck"></i>Transport Data<span><i class="fa-solid fa-plus"
                                        onclick="toggleDropdown(event)"></i></span></a>
                         <ul class=" dropdown-menu">
                              <li><a href="warehouse_wholesale_data.php"><i class="fa-solid fa-database"></i>
                                        Warehouse_wholesale Data</a></li>
                              <li><a href="retailer_wholesale_data.php"><i class="fa-solid fa-database"></i>
                                        Wholesale_Retailer Data</a></li>
                              <!-- <li><a href="retailers.php"><i class="fas fa-shopping-cart"></i> Retailers</a></li> -->
                         </ul>
                    </li>
