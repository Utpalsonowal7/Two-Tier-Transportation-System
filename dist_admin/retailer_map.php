     ...
     <div class="main-content">
          ...
          <div class="table-container">
               ...
               <table id="dataTable">
                    ...
                    <?php
                    $query = "SELECT * FROM  wholesale_retailer_map    WHERE district_id = $districtId  ORDER BY id   ASC";
                                   ...
                                   <td>
                                        <div class="button-group">
                                             <button class="update-btn"><a
                                                       href="edit_retailer_map.php?id=<?php echo urldecode(encrypt_id($row['id'])); ?>">Update</a></button>
                                             <button class="delete-btn"><a
                                                       href="delete_retailer_mapp.php?id=<?php echo $row['id']; ?>"
                                                       onclick="return  confirm('Are you sure want to delete this mapp?')">Delete</a></button>
                                        </div>
                                   </td>
                              </tr>
                              <?php
