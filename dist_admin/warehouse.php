...
// $total_query = "SELECT COUNT(*) AS total FROM warehouse  where district_id = $districtId";
     ...
     <div class="main-content">
          ...
          <div class="table-container">
               ...
               <table id="dataTable">
                    ...
                    <?php
                    $query = "SELECT * FROM warehouse  WHERE district_id = $districtId  ORDER BY name   ASC ";
                                   ...
                                   <td>
                                        <div class="button-group">
                                             ...
                                             <button class="update-btn"><a
                                                       href="edit_warehouse.php?id=<?php echo urlencode(encrypt_id($row['serial_no'])); ?>">Update</a></button>
                                             <button class="delete-btn"><a
                                                       href="delete_warehouse.php?id=<?php echo $row['serial_no']; ?>"
                                                       onclick="return confirm('are you sure want to delete this warehouse? ')">Delete</a></button>
                                        </div>
                                   </td>
                              </tr>
                              <?php
