...
// $total_query = "SELECT COUNT(*) AS total FROM district_users where district_id = $districtId";

// $total_result = pg_query($fsms_conn, $total_query);
// if (!$total_result) {
//      die("Count query failed: " . pg_last_error($fsms_conn));
// }
     ...
     <div class="main-content">
          ...
          <div class="table-container">
               ...
               <table id="dataTable">
                    ...
                    <?php
                    $query = "SELECT * FROM district_users  WHERE district_id = $districtId  ORDER BY username   ASC";
                                   ...
                                   <td>
                                        <div class="button-group">
                                             ...
                                             <button class="delete-btn"><a
                                                       ...
                                                       onclick="return confirm('are you sure want to delete this user?')">Delete</a></button>
                                             <button class="view-btn"><a
                                                       href="reset_district_userPass.php?id=<?php echo urlencode(encrypt_id($row['id'])); ?>">Reset Pass..</a></button>
                                        </div>
                                   </td>
                              </tr>
                              <?php
