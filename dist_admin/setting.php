...
$query = "SELECT name, username, mobile_number, password FROM  district_admins WHERE id = $1";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
     ...
     if (empty($name) || empty($username) || empty($mobile_number) || empty($password)) {
          ...
          if (!password_verify($password, $row['password'])) {
               ...
               $update_query = "UPDATE  district_admins SET name = $1, username = $2, mobile_number = $3 WHERE id = $4";
