...
if ($id) {
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          //      // $password = password_hash($password, PASSWORD_BCRYPT);
               ...
               $query = "UPDATE district_users  SET name=$1, username=$2,  mobile_number=$3,  status=$4::BOOlean WHERE id=$5";

               $updateResult = pg_query_params($fsms_conn, $query, [$name, $username, $mobile_number, $status, $id]);
