...
if (isset($_POST['login'])) {
     ...
     $query = "SELECT * FROM district_users   WHERE username = $1  FOR UPDATE";
     ...
     if (pg_num_rows($result) > 0) {
          ...
          if ($num['status'] === 'f' || $num['status'] === false) {
               echo "<script>alert('Your account is deactivated. Contact System admin.'); window.location.href='login.php';</script>";
               exit();
          }
          ...
          if (password_verify($pass, $num['password'])) {
               ...
               pg_query_params($fsms_conn, "UPDATE district_users SET otp = $1 WHERE id = $2", array($generateOtp, $num['id']));
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['otp'])) {
     ...
     $res = pg_query_params($fsms_conn, "SELECT otp FROM district_users WHERE username=$1", array($adminusername));
...
<head>
     ...
     <title>Dist User Login Form </title>
     <style>
     ...
     <div id="otpModal" class="modal">
          <div class="modal-content">
               ...
               <div class="modal-footer">
                    <p><a href="#" id="resendBtn">Resend OTP <span>&rarr;</span></a></p>
                    ...
                    function startTimer() {
                         ...
                         timerInterval = setInterval(() => {
                              ...
                              if (timeLeft <= 0) {
                                   ...
                                   otpTimer.textContent = "OTP expired. Click resend.";
