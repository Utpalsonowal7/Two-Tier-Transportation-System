...
<body>
     ...
     <div class="main-content">
          <div class="dashboard">
               ...
               <h3 class="slash">/</h3>
               <a href="#">
                    <h2>List of Fair Price Shops</h2>
               </a>
          </div>
          ...
          <div class="table-container">
               ...
               <table id="dataTable">
                    ...
                    <?php
                    $query = "SELECT * FROM fair_price_shop_data  WHERE district_id = $1  ORDER BY name   ASC";
                    $result = pg_query_params($master_conn, $query, [$districtId]);
                    if (!$result) {
                    ...
                    <tbody>
                         ...
                         while ($row = pg_fetch_assoc($result)) {
                              ...
                              <tr>
                                   ...
                                   <td><?php echo $row['wholesaler_distance']; ?></td>
